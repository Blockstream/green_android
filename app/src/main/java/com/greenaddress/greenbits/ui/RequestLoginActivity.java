        ...
        public void onFailure(final Throwable t) {
            ...
            if (Throwables.getRootCause(t) instanceof LoginFailed) {
                ...
                try {
                    ...
                    Futures.addCallback(mService.signup(mHwWallet, "HW", KeyUtils.compressPublicKey(masterPublicKey.getPublicKey()), masterPublicKey.getChainCode(), KeyUtils.compressPublicKey(loginPublicKey.getPublicKey()), loginPublicKey.getChainCode()),
                            new FutureCallback<LoginData>() {
                                @Override
                                public void onSuccess(final LoginData result) {
                                    RequestLoginActivity.this.onLoginSuccess();
