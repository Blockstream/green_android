...
class RecoveryInstructionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        AnalyticsManager.shared.recordView(.recoveryIntro, sgmt: AnalyticsManager.shared.onBoardSgmt(onBoardParams: OnBoardManager.shared.params, flow: AnalyticsManager.OnBoardFlow.strCreate))
    }
