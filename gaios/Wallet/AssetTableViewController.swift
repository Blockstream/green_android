...
class AssetTableViewController: UITableViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        title = NSLocalizedString("id_asset", comment: "")
        hexTitle.text = NSLocalizedString("ASSET ID", comment: "")
        decimalsTitle.text = NSLocalizedString("PRECISION", comment: "")
        tickerTitle.text = NSLocalizedString("TICKER", comment: "")
        labelTitle.text = NSLocalizedString("NAME", comment: "")
