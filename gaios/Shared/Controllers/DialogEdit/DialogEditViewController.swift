...
class DialogEditViewController: KeyboardViewController {
    ...
    weak var delegate: DialogEditViewControllerDelegate?
    ...
    override func viewDidLoad() {
        ...
        nameTextField.placeholder = "id_add_a_note_only_you_can_see_it".localized
    ...
    func dismiss(_ action: NoteAction) {
        anchorBottom.constant = -cardView.frame.size.height
