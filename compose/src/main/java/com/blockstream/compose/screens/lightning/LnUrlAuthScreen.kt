...
data class LnUrlAuthScreen(
    ...
    override fun Content() {
        val viewModel = koinViewModel<LnUrlAuthViewModel>() {
...
fun LnUrlAuthScreen(
    ...
    ConstraintLayout(
        ...
        GreenColumn(modifier = Modifier.constrainAs(middleContent) {
            ...
            Text(
                stringResource(R.string.id_you_can_use_your_wallet_to),
        ...
        GreenColumn(modifier = Modifier.constrainAs(bottomContent) {
            ...
            GreenColumn(padding = 0) {
                Text(
                    stringResource(R.string.id_no_personal_data_will_be_shared),
                    textAlign = TextAlign.Center,
                    style = bodySmall,
                    modifier = Modifier.fillMaxWidth()
                )
                GreenButton(
                    text = stringResource(R.string.id_authenticate),
                    modifier = Modifier
                        .fillMaxWidth()
                ) {
