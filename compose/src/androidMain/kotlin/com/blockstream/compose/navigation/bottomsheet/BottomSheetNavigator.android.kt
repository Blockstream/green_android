...
/**
 * Navigator that drives a [ModalBottomSheetState] for use of [com.blockstream.compose.navigation.bottomsheet.ModalBottomSheetLayout]s
 * with the navigation library. Every destination using this Navigator must set a valid
 * [Composable] by setting it directly on an instantiated [com.blockstream.compose.navigation.bottomsheet.Destination] or calling
 * [navigation.bottomSheet].
 *
 * <b>The [sheetInitializer] [Composable] will always host the latest entry of the back stack. When
 * navigating from a [com.blockstream.compose.navigation.bottomsheet.BottomSheetNavigator.Destination] to another
 * [com.blockstream.compose.navigation.bottomsheet.BottomSheetNavigator.Destination], the content of the sheet will be replaced instead of a
 ...
 * [com.blockstream.compose.navigation.bottomsheet.rememberBottomSheetNavigator] instead.
 *
 * @param sheetState The [ModalBottomSheetState] that the [com.blockstream.compose.navigation.bottomsheet.BottomSheetNavigator] will use to
 * drive the sheet state
 */
@Navigator.Name("bottomSheet")
public actual class BottomSheetNavigator : Navigator<Destination>() {
    ...
    /**
     * Access properties of the [com.blockstream.compose.navigation.bottomsheet.ModalBottomSheetLayout]'s [ModalBottomSheetState]
     */
     ...
     * sheetContent of your [com.blockstream.compose.navigation.bottomsheet.ModalBottomSheetLayout].
     */
