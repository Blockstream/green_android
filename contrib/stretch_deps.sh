...
apt-get -yqq install openjdk-8-jdk ca-certificates-java unzip curl make swig autoconf libtool pkg-config libc6:i386 libc6-dev:i386 libncurses5:i386 libstdc++6:i386 lib32z1 python
