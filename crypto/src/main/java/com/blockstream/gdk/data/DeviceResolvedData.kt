...
data class DeviceResolvedData constructor(
    ...
    @SerialName("asset_blinders") val assetBlinders: List<String>? = null,
    @SerialName("amount_blinders") val amountBlinders: List<String>? = null,
    ...
    override fun kSerializer(): KSerializer<DeviceResolvedData> {
        return serializer()
    }
}