...
data class HandshakeInitResponse constructor(
    ...
    @SerialName("method") val method: String = "handshake_init",
    @SerialName("params") val params: HandshakeInit,
...
data class HandshakeCompleteResponse constructor(
    @SerialName("id") val id: String = "C3PO", // From Docs, what can i do?
    @SerialName("method") val method: String = "handshake_complete",
    @SerialName("params") val params: HandshakeComplete,
