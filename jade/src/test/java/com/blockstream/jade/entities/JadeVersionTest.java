...
public class JadeVersionTest {
    ...
    public void test_ctor_parse() {
        ...
        Assert.assertEquals(0, ver0.major);
        Assert.assertEquals(1, ver0.minor);
        Assert.assertEquals(21, ver0.patch);
        ...
        Assert.assertEquals(3, ver1.major);
        Assert.assertEquals(5, ver1.minor);
        Assert.assertEquals(4, ver1.patch);
        ...
        Assert.assertEquals(0, ver2.major);
        Assert.assertEquals(1, ver2.minor);
        Assert.assertEquals(22, ver2.patch);
        ...
        Assert.assertEquals(0, ver2a.major);
        Assert.assertEquals(2, ver2a.minor);
        Assert.assertEquals(11, ver2a.patch);
        ...
        Assert.assertEquals(0, ver3.major);
        Assert.assertEquals(1, ver3.minor);
        Assert.assertEquals(22, ver3.patch);
        ...
        Assert.assertEquals(0, ver3a.major);
        Assert.assertEquals(2, ver3a.minor);
        Assert.assertEquals(11, ver3a.patch);
        ...
        Assert.assertEquals(1, ver4.major);
        Assert.assertEquals(3, ver4.minor);
        Assert.assertEquals(2, ver4.patch);
        ...
        Assert.assertEquals(1, ver5.major);
        Assert.assertEquals(5, ver5.minor);
        Assert.assertEquals(23, ver5.patch);
        ...
        Assert.assertEquals(3, ver5a.major);
        Assert.assertEquals(7, ver5a.minor);
        Assert.assertEquals(16, ver5a.patch);
        ...
        Assert.assertEquals(1, ver6.major);
        Assert.assertEquals(5, ver6.minor);
        Assert.assertEquals(23, ver6.patch);
        ...
        Assert.assertEquals(3, ver6a.major);
        Assert.assertEquals(7, ver6a.minor);
        Assert.assertEquals(16, ver6a.patch);
    ...
    public void check_string_representation() {
        ...
        for (final String version : versions) {
            ...
            Assert.assertEquals(0, ver.compareTo(same));
            Assert.assertEquals(0, same.compareTo(ver));
    ...
    private void check_versions_array(final JadeVersion[] versions) {
        for ( int i = 0; i < versions.length; ++i) {
            ...
            Assert.assertEquals(0, versions[i].compareTo(versions[i]));
