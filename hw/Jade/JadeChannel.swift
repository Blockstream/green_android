...
public class JadeChannel: HWChannelProtocol {

    public var peripheral: Peripheral!
    var characteristicWrite: Characteristic?
    var characteristicNotify: Characteristic?

    public static let SERVICE_UUID = CBUUID(string: "6e400001-b5a3-f393-e0a9-e50e24dcca9e")
    public static let WRITE_CHARACTERISTIC_UUID = CBUUID(string: "6e400002-b5a3-f393-e0a9-e50e24dcca9e")
    public static let CLIENT_CHARACTERISTIC_CONFIG = CBUUID(string: "6e400003-b5a3-f393-e0a9-e50e24dcca9e")
    var MTU: UInt8 = 128
    var TIMEOUT: Int = 30
    ...
    public func read(_ prefix: Data? = nil) -> Observable<Data> {
