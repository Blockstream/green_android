...
public class LedgerCommands: LedgerChannel {
    ...
    public func pubKey(path: [Int]) -> Observable<[String: Any]> {
    ...
    public func version() -> Observable<[String: Any]> {
    ...
    public func deviceInfo() -> Observable<[String: Any]> {
    ...
    public func firmware() -> Observable<Bool> {
    ...
    public func application() -> Observable<[String: Any]> {
    ...
    public func openApp(name: String) -> Observable<Bool> {
    ...
    public func quitApp() -> Observable<Bool> {
