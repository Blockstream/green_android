...
public class LedgerChannel: HWChannelProtocol {

    var peripheral: Peripheral!
    var characteristicWrite: Characteristic?
    var characteristicNotify: Characteristic?

    public static let SERVICE_UUID = CBUUID(string: "13D63400-2C97-0004-0000-4C6564676572")
    public static let WRITE_CHARACTERISTIC_UUID = CBUUID(string: "13D63400-2C97-0004-0002-4C6564676572")
    public static let NOTIFY_CHARACTERISTIC_UUID = CBUUID(string: "13D63400-2C97-0004-0001-4C6564676572")
    public static let CLIENT_CHARACTERISTIC_CONFIG = CBUUID(string: "00002902-0000-1000-8000-00805f9b34fb")
    var MTU = 128
    ...
    public func open(_ peripheral: Peripheral) -> Observable<Data> {
    ...
    public func close() -> Observable<Data> {
    ...
    public func exchange(_ data: Data) -> Observable<Data> {
        #if DEBUG
